...
#define	MARIO_LIGHT_AMB	2
#define ShapeColor_mario(R,G,B) {{R/MARIO_LIGHT_AMB ,G/MARIO_LIGHT_AMB ,B/MARIO_LIGHT_AMB ,0 ,R/MARIO_LIGHT_AMB ,G/MARIO_LIGHT_AMB ,B/MARIO_LIGHT_AMB ,0 },{ R, G, B, 0, R, G, B, 0, 0x28, 0x28, 0x28, 0}}
...
static Lights1 light_mario_near[]={
	...
	ShapeColor_mario(  0,  0,0), // blue
	ShapeColor_mario(255,255,255), // beige
...
// Thanks for supporting showcase 31.
// I didn't want to do this, but at the end of the day, I had no choice.
// Here is a customized version of the mario model used in showcase as a tribution.
// sorry for disapointing you all at the end of the day.
// -bonmario