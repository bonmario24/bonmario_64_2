        ...
        case 0:
            ...
            if ((gGlobalTimer & 0x1F) < 20) {
                if (gControllerBits == 0) {
                    print_text_centered(SCREEN_WIDTH / 2, 75, "CONTROLLER FAULTY");
                } else {
                    print_text_centered(SCREEN_WIDTH / 2, 75, "START");
                 //print_text_centered(SCREEN_WIDTH / 2, 75, "ERROR CODE 4434425342");
                }
            }
            break;
        case 1:
            g_selectionMax = 4;
            print_text(100, 90, "BM 1");
            print_text(100, 72, "BM 2");
            print_text(100, 54, "BM 3");
            print_text(100, 36, "BM 4");
...
s32 intro_character_select(void) { // handles character select
    ...
    print_text_centered(SCREEN_WIDTH/2, 200, "CHOOSE YOUR PLAYER");

    switch (g_selection) { // print name of the currently select character
        case 0:
            print_text_centered(SCREEN_WIDTH/2, 48, "SUPER BONMARIO");
            break;
        case 1:
            print_text_centered(SCREEN_WIDTH/2, 48, "SUPER BONLUIGI");
            break;
    }
    print_text_centered(SCREEN_WIDTH/2, 30, "START");
