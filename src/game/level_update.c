...
const char *credits01[] = { "1GAME DIRECTOR", "BONMARIO" };
...
const char *credits07[] = { "2COURSE DIRECTORS", "TRUE", "YASUHISA YAMAMURA" };
...
const char *credits06[] = { "2COURSE DIRECTORS", "TRUE", "YASUHISA YAMAMURA" };
